...
import { generateUniqueCode, formatCode } from '../utils/generateCode';
...
const GroupLeaderRegistration: React.FC = () => {
  ...
  const resetForm = () => {
    setFormData({ groupName: '', leaderName: '', leaderEmail: '', leaderPhone: '' });
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Group Registered Successfully!</h2>
            <p className="text-gray-600">Your group "{formData.groupName}" has been created. Share the code or QR code with your team members.</p>
          </div>

          <div className="space-y-6">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Group Code</h3>
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Register as Group Leader</h2>
          <p className="text-gray-600">Create a new volunteer group and get your unique joining code</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="leaderEmail" className="block text-sm font-medium text-gray-700 mb-2">
              Email Address
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="leaderPhone" className="block text-sm font-medium text-gray-700 mb-2">
              Phone Number
            </label>
            <input
              type="tel"
